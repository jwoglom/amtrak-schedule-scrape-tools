...
def parse_folder(data_folder, filter_dates=None, filter_snapshots=None, with_detail=False):
    #print(f'{data_folder=}')
    ret = {}
    for folder in os.listdir(data_folder):
        ...
        for file in os.listdir(folder_path):
            ...
            run = subprocess.run(f'cat {file_path}|./postprocess.sh', shell=True, capture_output=True)
            snapshot = json.loads(run.stdout.decode().strip())
